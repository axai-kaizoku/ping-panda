...
import { NumericFieldsSumCards } from "./numeric-fields-sum-cards"
...
export type NumericFieldSumsType = Record<
  string,
  {
    total: number
    thisWeek: number
...
export default function CategoryPageContent({
  ...
  // Tabs state
  const [activeTab, setActiveTab] = useQueryState<"today" | "week" | "month">(
    "tab",
    {
      defaultValue: "today",
      clearOnDefault: false,
      parse: (value) =>
        ["today", "week", "month"].includes(value)
  ...
  const numericFieldSums = useMemo(() => {
    ...
    const sums: NumericFieldSumsType = {}
  ...
  // Return empty page until first event occurs
