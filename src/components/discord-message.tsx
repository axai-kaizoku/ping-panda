...
const getBadgeStyles = (color: BadgeColor) => {
  switch (color) {
    ...
    case "#faa61a":
      ...
      defualt: return "bg-gray-500/10 text-gray-400 ring-gray-500/20"
  }
}
        ...
        <div className="bg-[#2f3136] text-sm w-full rounded p-3 mb-4 mt-1.5">
          <div className="flex flex-row items-center justify-between mb-2">
            {badgeText ? (
              <span
                className={cn(
                  "inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset order-2",
